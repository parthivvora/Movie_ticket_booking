...
function MovieDetails() {
  ...
  return (
    <div className='movie-part-details'>
      <Navbar />
      <section className="details-banner bg_img">
        <div className="container">
          <div className="details-banner-wrapper">
            <div className="details-banner-thumb">
              <img src={require("../../images/movie/venus.jpg")} alt="movie" />
              <a href="https://www.youtube.com/embed/KGeBMAgc46E" className="video-popup">
                <img src={require("../../images/movie/video-button.png")} alt="movie" />
              </a>
            </div>
            ...
            <div className="left-side">
              <div className="item">
                <div className="item-header">
                  <div className="thumb">
                    <img src={require("../../images/movie/tomato2.png")} alt="movie" />
                  </div>
              ...
              <div className="item">
                <div className="item-header">
                  <div className="thumb">
                    <img src={require("../../images/movie/cake2.png")} alt="movie" />
                  </div>
                  <div className="counter-area">
                    <span className="counter-item odometer" data-odometer-final={88}>0</span>
                  </div>
              ...
              <div className="widget-1 widget-offer">
                ...
                <div className="offer-body">
                  <div className="offer-item">
                    <div className="thumb">
                      <img src={require("../../images/sidebar/offer01.png")} alt="sidebar" />
                    </div>
                  ...
                  <div className="offer-item">
                    <div className="thumb">
                      <img src={require("../../images/sidebar/offer02.png")} alt="sidebar" />
                    </div>
                    <div className="content">
                      <h6>
                  ...
                  <div className="offer-item">
                    <div className="thumb">
                      <img src={require("../../images/sidebar/offer03.png")} alt="sidebar" />
                    </div>
                    <div className="content">
                      <h6>
                ...
                <div className="details-photos owl-carousel">
                  <div className="thumb">
                    <a href="assets/images/movie/movie-details01.jpg" className="img-pop">
                      <img src={require("../../images/movie/movie-details01.jpg")} alt="movie" />
                    </a>
                  </div>
                  <div className="thumb">
                    <a href="assets/images/movie/movie-details02.jpg" className="img-pop">
                      <img src={require("../../images/movie/movie-details02.jpg")} alt="movie" />
                    </a>
                  </div>
                  <div className="thumb">
                    <a href="assets/images/movie/movie-details03.jpg" className="img-pop">
                      <img src={require("../../images/movie/movie-details03.jpg")} alt="movie" />
                    </a>
                  </div>
                  <div className="thumb">
                    <a href="assets/images/movie/movie-details01.jpg" className="img-pop">
                        ...
                        <div className="casting-slider owl-carousel">
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast01.jpg")} alt="cast" />
                              </a>
                            </div>
                          ...
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast02.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                          ...
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast03.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                          ...
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast04.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                      ...
                      <div className="item">
                        ...
                        <div className="casting-slider-two owl-carousel">
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast05.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                          ...
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast06.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                          ...
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast07.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                          ...
                          <div className="cast-item">
                            <div className="cast-thumb">
                              <a href="#0">
                                <img src={require("../../images/cast/cast08.jpg")} alt="cast" />
                              </a>
                            </div>
                            <div className="cast-content">
                      ...
                      <div className="movie-review-item">
                        <div className="author">
                          ...
                          <div className="movie-review-info">
                            ...
                            <span><i className="fa-solid fa-check" /> verified review</span>
                          </div>
                        </div>
                        <div className="movie-review-content">
                          <div className="review">
                            <i className="fa-solid fa-heart" />
                            <i className="fa-solid fa-heart pl-1" />
                            <i className="fa-solid fa-heart pl-1" />
                            <i className="fa-solid fa-heart pl-1" />
                            <i className="fa-solid fa-heart pl-1" />
                          </div>
