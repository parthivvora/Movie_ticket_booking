                            ...
                            <div className="tab-item active">
                                <form className="ticket-search-form">
                                    <div className="form-group large">
                                        ...
                                        <button type="submit"><i className="fa-solid fa-search" /></button>
                                    </div>
                            ...
                            <div className="widget-1 widget-facility">
                                <div className="widget-1-body">
                                    <ul>
                                        <li>
                                            <a href="#0">
                                                <span className="img"><img src={require("../images/sidebar/icons/sidebar01.png")} alt="sidebar" /></span>
                                                <span className="cate">24X7 Care</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#0">
                                                <span className="img"><img src={require("../images/sidebar/icons/sidebar02.png")} alt="sidebar" /></span>
                                                <span className="cate">100% Assurance</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#0">
                                                <span className="img"><img src={require("../images/sidebar/icons/sidebar03.png")} alt="sidebar" /></span>
                                ...
                                <div className="row mb-30-none justify-content-center">
                                        ...
                                        <div className="movie-grid">
                                            ...
                                            <div className="movie-content bg-one">
                                                ...
                                                <ul className="movie-rating-percent">
                                                    <li>
                                                        <div className="thumb">
                                                            <img src={require("../images/movie/tomato.png")} alt="movie" />
                                                        </div>
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="movie-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/movie/movie02.jpg")} alt="movie" />
                                                </a>
                                            </div>
                                            <div className="movie-content bg-one">
                                                <h5 className="title m-0">
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="movie-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/movie/movie03.jpg")} alt="movie" />
                                                </a>
                                            </div>
                                            <div className="movie-content bg-one">
                                                <h5 className="title m-0">
                                ...
                                <div className="row mb-30-none justify-content-center">
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="event-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/event/event02.jpg")} alt="event" />
                                                </a>
                                                <div className="event-date">
                                                    <h6 className="date-title">28</h6>
                                                    <span>Dec</span>
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="event-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/event/event03.jpg")} alt="event" />
                                                </a>
                                                <div className="event-date">
                                                    <h6 className="date-title">28</h6>
                                                    <span>Dec</span>
                                ...
                                <div className="row mb-30-none justify-content-center">
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="sports-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/sports/sports01.jpg")} alt="sports" />
                                                </a>
                                                <div className="event-date">
                                                    <h6 className="date-title">28</h6>
                                                    <span>Dec</span>
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="sports-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/sports/sports02.jpg")} alt="sports" />
                                                </a>
                                                <div className="event-date">
                                                    <h6 className="date-title">28</h6>
                                                    <span>Dec</span>
                                    ...
                                    <div className="col-sm-6 col-lg-4">
                                        <div className="sports-grid">
                                            <div className="movie-thumb c-thumb">
                                                <a href="#0">
                                                    <img src={require("../images/sports/sports03.jpg")} alt="sports" />
                                                </a>
                                                <div className="event-date">
                                                    <h6 className="date-title">28</h6>
                                                    <span>Dec</span>
