...
import { addContactUs } from "../global/apiCall";
...
function Contact() {
  ...
  const handleSubmitContactInfo = async (e) => {
    e.preventDefault();
    isAuthenticated
      ? await addContactUs(addContactInfo)
          .then((response) => {
            successHandler(response.data.message);
            setAddContactInfo({ name: "", email: "", message: "" });
          })
          .catch((error) => {
                ...
                >
                  <div className="form-group">
                    ...
                    <input
                      ...
                      id="name"
                      required
                      onChange={handleGetContactInfo}
                      value={addContactInfo.name}
                    />
                  </div>
                  <div className="form-group">
                    <label htmlFor="email">
                  ...
                  <div className="info-area">
                    <div className="info-item">
                      <div className="info-thumb">
                        <img
                          src={require("../images/contact/contact01.png")}
                          alt="contact"
                        />
                      </div>
                    ...
                    <div className="info-item">
                      <div className="info-thumb">
                        <img
                          src={require("../images/contact/contact02.png")}
                          alt="contact"
                        />
                      </div>
                      <div className="info-content">
